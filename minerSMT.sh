...
./kill_miniZeph.sh
sleep 3
sudo /root/cpuminer-opt-linux/cpuminer-sse2 --background --threads=$cores -a yespower -o stratum+tcps://$fastest_server:17111 -u a9SSiQD8S7wekwevvHM3ENQpPaE87ove2g.SMT -p m=solo
sleep 3
EOF
