...
#!/bin/bash
sudo /root/xmrig-6.21.0/xmrig --background --threads=$cores -a ghostrider --url randomx.rplant.xyz:17110 --tls --user dQwRbzRghkWYB9MPj4PdX7Rt5uF4SZtfES.DUN --pass m=solo
sleep 4
EOF
