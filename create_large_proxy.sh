...
wget "https://raw.githubusercontent.com/minhchau91/createproxy/main/Rotation_large.sh" --output-document=/root/Rotation.sh
...
#day
#30 7 */2 * * /root/Rotation.sh > /root/Rotation_log.txt
#day - time
#59 7 * * * /root/Rotation.sh > /root/Rotation_log.txt
00 7 * * * /root/Rotation.sh > /root/Rotation_log.txt
...
#0 */2 * * * /root/Rotation.sh > /root/Rotation_log.txt
#RebootNetwork
30-55/30 * * * * /root/rebootNetwork.sh > /root/rebootNetwork_log.txt
EOF
